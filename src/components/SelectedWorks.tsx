...
import projectHuman from "@/assets/project-human.jpg";
import projectBrand from "@/assets/project-brand.jpg";

const projects = [
  { title: "Automotive Motion", image: projectAutomotive, span: "md:col-span-7", aspect: "aspect-[4/3]" },
  { title: "Urban Architecture", image: projectArchitecture, span: "md:col-span-5", aspect: "aspect-[3/4]" },
  { title: "Human Perspective", image: projectHuman, span: "md:col-span-5", aspect: "aspect-[3/4]" },
  { title: "Brand Identity", image: projectBrand, span: "md:col-span-7", aspect: "aspect-[4/3]" },
];
